...
public class DB05Main implements Query {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 2. 쿼리연산(들) 수행
			stmt.executeUpdate("INSERT INTO test_member(mb_name) VALUES ('aaa')");
			stmt.executeUpdate("INSERT INTO test_member(mb_name) VALUES ('bbb')");
			stmt.executeUpdate("INSERT INTO test_member(mb_name) VALUES ('ccc')");
			stmt.executeUpdate("INSERT INTO test_member(mb_name) VALUES ('ddd')");
