...
public class Inner01Main {
	...
	public static void main(String[] args) {
		...
		TestOuter.TestInner in3 = out.new TestInner(256);
		
		System.out.println("outer class의 value와 in2의 innerValue ");
		in2.printOuterValue();
		in2.printInnerValue();
		
		System.out.println();
		
		System.out.println("outer class의 value와 in3의 innerValue ");
		in3.printOuterValue();
		in3.printInnerValue();
